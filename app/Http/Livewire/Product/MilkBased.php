...
use App\Models\Kopi;
use App\Models\MilkBased as MilkBas;
use App\Models\User;
use Illuminate\Support\Facades\Auth;
use Livewire\Component;

class MilkBased extends Component
{
    public function render()
    {
        ...
        return view('livewire.homepage', ['kopis' => Category::find(2)->kopis, 'users' => User::get(), 'product_order' => $idk]);
    }  
